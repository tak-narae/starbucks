            ...
            <div className="header_nav">
                ...
                <div className="customer">
                    <ul className="menu_util">
                        <li><Link to="/event?cate=전체"><img src={require('../../images/header_util1.png')} alt="이벤트" /><span>이벤트</span></Link></li>
                        <li><Link to="/notice?cate=전체"><img src={require('../../images/header_util2.png')} alt="공지사항" /><span>공지사항</span></Link></li>
