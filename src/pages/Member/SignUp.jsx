...
const SignUp = () => {
  ...
  const handleSubmit = () => {};
  return (
    <div id="container" className="member__signup">
        ...
        <form action="#" method="post" name="signup" onSubmit={handleSubmit}>
          <fieldset className="signup__area">
            <ul className="terms_section">
              <li className="terms">
                <input type="checkbox" id="check" className="check_style"
                  checked={allChecked}
                ...
                <h3>
                  ...
                  스타벅스 카드 이용약관, 마케팅 활용 수집·이용(선택)에 모두
                  동의합니다.
                </h3>
              </li>
              <hr />
              <li className="terms">
                ...
                <div className="terms_scroll_box">
                  <ul className="pri_terms_wrap">
                    ...
                    <li>
                        <p class="pri_tit" id="quick_03">제 4 장 스타벅스 모바일 상품권 서비스</p>
                        <ol class="pri_con pri_con2 mb40">
                            <li>
                            ...
                            <li>
                                <p id="quick_04_02" class="sub_tit">제 23조 스타벅스 모바일 상품권 서비스 이용에 관한 총칙</p>
                                <ol class="mb40">
                                    <li>
                                        1. 이용의 제한
                                        <ol>
                    ...
                    <li>
                        ...
                        <ol class="pri_con pri_con2 mb40">
                            ...
                            <li>
                                <p id="quick_06_03" class="sub_tit">제52조 단체 주문 배달 서비스의 이용 및 변경</p>
                                <ol class="mb40">
                            ...
                            <li>
                                <p id="quick_06_04" class="sub_tit">제53조 단체 주문 배달 서비스 결제 및 주문 취소 등</p>
                                <ol class="mb40">
                    ...
                    <li>
                        ...
                        <ol class="pri_con pri_con2 mb40">
                            <li>
                                <p id="quick_06_01" class="sub_tit">제 55 조 전자영수증(e-Receipt &amp; History)의 발행 및 거래 내역의 확인</p>
                                <ol class="mb40">
                        ...
                        <ol class="pri_con pri_con2 mb40">
                            <li>
                                <p><span class="color_point">본 이용약관은 2024년 11월 19일부터 시행합니다.</span></p>
                            </li>
                        </ol>
                    </li>
                    <li>
              ...
              <li className="terms">
                ...
                <div className="terms_scroll_box">
                    <ul className="pri_terms_wrap">
                        <li>
                            <p class="mb15">본인은 스타벅스 코리아를 운영하는 주식회사 에스씨케이컴퍼니(이하 '회사'라 합니다)가 제공하는 회원 서비스(이하 ‘서비스’라 합니다)를 이용하기 위해, 다음과 같이 ‘회사’가 본인의 개인정보를 수집/이용하는 것에 동의합니다.</p>
                        </li>
                        <li>
